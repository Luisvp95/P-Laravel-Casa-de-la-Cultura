...
class PersonaController extends Controller
{
    ...
    {
        $this->middleware('permission:ver-persona|crear-persona||detalle-persona|editar-persona|borrar-persona', ["only"=>['index']]);
        $this->middleware('permission:crear-persona', ['only'=>['create','store']]);
        $this->middleware('permission:detalle-persona', ['only'=>['show']]);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('personas.index')
            ->with('success', 'Persona creado satisfactoriamente.');
    }
    ...
    public function update(Request $request, Persona $persona)
    {
        ...
        return redirect()->route('personas.index')
            ->with('success', 'Persona actualizado satisfactoriamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('personas.index')
            ->with('success', 'Persona borrado satisfactoriamente');
    }
}
